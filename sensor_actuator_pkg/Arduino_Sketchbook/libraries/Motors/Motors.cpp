...
void initializeVerticalMotors(){
	...
	vertSpeedController[0].writeMicroseconds(1500);
	vertSpeedController[1].writeMicroseconds(1500);
	vertSpeedController[2].writeMicroseconds(1500);
	vertSpeedController[3].writeMicroseconds(1500);
...
void setVerticalMotorSpeed(int frontRight, int frontLeft, int backRight, int backLeft){
	if(verticalInitialized){
		vertSpeedController[0].writeMicroseconds(speedToMicroseconds(frontRight));
		vertSpeedController[1].writeMicroseconds(speedToMicroseconds(frontLeft));
		vertSpeedController[2].writeMicroseconds(speedToMicroseconds(backRight));
		vertSpeedController[3].writeMicroseconds(speedToMicroseconds(backLeft));
	}
}
