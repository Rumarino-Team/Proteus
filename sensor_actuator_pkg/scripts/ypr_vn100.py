...
def talker():
    pub_y = rospy.Publisher('align_current', Float32, queue_size=10)
    pub_p = rospy.Publisher('pitch_current', Float32, queue_size=10)
    pub_r = rospy.Publisher('roll_current', Float32, queue_size=10)
