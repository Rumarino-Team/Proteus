...
from controller_pkg.msg import ControllerSetup, ForwardsCommand, HorizontalMotors, VerticalMotors
from common_pkg.msg import VisionIn, VisionOut
...
align_set_point = rospy.Publisher("align_input", Float32, queue_size=10)
...
depth_set_point = rospy.Publisher("depth_input", Float32, queue_size=10)
...
vertical_motors = rospy.Publisher("vertical_motors", VerticalMotors, queue_size=10)
